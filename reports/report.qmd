...
GITHUB URL:  <https://github.com/cmsc-vcu/cmsc408-sp2025-hw8-caitlin-b111>
...
According to the World Bank, in 2020 there were how many countries in the world? 217
...
What are all unique values of region in the wdi_country table? 7
...
I definetely feel confident in the select, right and left joins, lastly using not null as a parameter. I feel Ican use more practice creatin tables from tables. I definetely used a lot to build my reinforcement in this assignment.

2. Problem-Solving Approach: Describe your approach to tackling the more complex tasks (like Tasks 18, 23, and 24). How did you break down these problems, and what steps did you take when you encountered challenges? How would you approach a similar problem differently in the future?

I broke it down by using my past knowledge from the prior questions and thinking about the fact I'd need a solid base first. When I encountered challenged I took a step back to think about everything and scroll through the other questions.


3. Learning Takeaways: Consider the overall learning experience from this assignment. What were the biggest takeaways about working with SQL for data analysis and transformation? How do you think these skills will apply in real-world scenarios or future coursework?

Being able to break things down and extract only the neccesary information. This applies everywhere in life for simplification. 
